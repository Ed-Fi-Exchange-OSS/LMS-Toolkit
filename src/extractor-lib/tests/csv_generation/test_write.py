...
def describe_when_calling_write_multi_csv_with_one_dataframe():
    @patch("edfi_lms_extractor_lib.csv_generation.write._write_csv")
    def it_should_call_write_csv_once_with_df1(mock_write_csv):
        ...
        # act
        _write_multi_csv(dfs_to_write, OUTPUT_DATE, MULTI_CSV_TEMPLATE)
...
def describe_when_calling_write_multi_tuple_csv_with_one_dataframe():
    ...
    def it_should_call_write_csv_once_with_df1(mock_write_csv):
        ...
        # act
        _write_multi_tuple_csv(dfs_to_write, OUTPUT_DATE, MULTI_TUPLE_CSV_TEMPLATE)
