...
123457,teacher,0,1"""
        ...
        # Act
        cls.result = map_to_udm(users_df, roles_df)
    ...
    def test_then_source_system_identifier_is_mapped(self):
        assert self.result.at[0, "SourceSystemIdentifier"] == "100032890"
    ...
    def test_then_local_user_identifier_is_mapped(self):
        assert self.result.at[0, "LocalUserIdentifier"] == "mary.archer"

    def test_then_sis_user_identifier_is_not_set(self):
        assert self.result.at[0, "SISUserIdentifier"] == "604863"

    def test_then_name_is_mapped(self):
        assert self.result.at[0, "Name"] == "Mary Catherine Archer"

    def test_name_does_not_have_two_spaces_when_middle_name_is_missing(self):
        assert self.result.at[1, "Name"] == "Brad Banister"
