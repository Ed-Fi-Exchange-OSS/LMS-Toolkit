...
class Submissions:
    """
    The Submissions class contains methods to get submissions' information from Schoology API
    ...
    def get_by_section_id(self, section_id):
        response = self.request_client.get(f"sections/{section_id}/submissions")
        return response
