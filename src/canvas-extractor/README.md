...
Licensed under the [Apache License, Version 2.0](https://github.com/Ed-Fi-Exchange-OSS/LMS-Toolkit/https://github.com/Ed-Fi-Exchange-OSS/LMS-ToolkitLICENSE) (the "License").
