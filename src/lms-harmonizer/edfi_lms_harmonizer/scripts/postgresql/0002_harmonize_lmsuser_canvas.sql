...
as $$
    ...
    and
        -- NOTE: PostgreSQL is case sensitive and this won't match "canvas".
        -- Using "Canvas" is safe given the Canvas Extractor writes out its
        -- CSV files with "Canvas", not "canvas"
