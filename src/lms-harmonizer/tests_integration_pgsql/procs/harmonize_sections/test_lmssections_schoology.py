...
def describe_when_harmonizing_schoology_sections():
    ...
    def describe_given_lms_and_ods_tables_have_no_matches():
        def it_should_run_successfully(test_db_config: PgsqlServerConfig):
            SIS_ID_1 = "s_sis_id_1_a"
            SIS_ID_2 = "s_sis_id_2_a"
            ...
            with PgsqlConnection(test_db_config).pyodbc_conn() as connection:
                ...
                insert_edfi_section(connection, "s_not_matching_sis_id_1")
                insert_edfi_section(connection, "s_not_matching_sis_id_2")
    ...
    def describe_given_lms_and_ods_tables_have_a_match():
        SIS_ID = "s_sis_id_2"
        SECTION_ID = "3C200000-0000-0000-0000-000000000000"
    ...
    def describe_given_lms_and_ods_tables_have_a_match_to_deleted_record():
        SECTION_ID = "3C300000-0000-0000-0000-000000000000"
        SIS_ID = "s_sis_id_3"
    ...
    def describe_given_lms_and_ods_tables_have_one_match_and_one_not_match():
        SECTION_ID = "3C400000-0000-0000-0000-000000000000"
        SIS_ID = "s_sis_id_4"
        NOT_MATCHING_SIS_ID = "s_not_matching_sis_id"
        ...
        def it_should_run_successfully(test_db_config: PgsqlServerConfig):
            ...
            with PgsqlConnection(test_db_config).pyodbc_conn() as connection:
                ...
                insert_edfi_section(
                    connection, "s_also_not_matching_sis_id"
                )  # Not matching section
